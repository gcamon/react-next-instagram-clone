    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                ...
                justify-center min-h-[800px] 
                sm:min-h-screen pt-4 pb-20 text-center
                sm:block sm:p-0'>
                    <Transition.Child
                        as={Fragment}
                       ...
                       sm:align-middle sm:max-w-sm sm:w-full'>
                           <div>
                               { selectedFile ? (
                                   <img 
                                    ...
                                    justify-center h-12 w-12 rounded-full bg-red-100 cursor-pointer'>
                                        <CameraIcon
                           ...
                           <div className='mt-5 sm:mt-6'>
                                <button
                                    ...
                                    sm:text-sm disabled:bg-gray-300 
